...
class __TwigTemplate_52d18cf7cf03e5d9066a47999cf85785c472dccd7b1f46ca0ae109f640507e55 extends Twig_Template
{
                ...
                if ( !$this->getAttribute($context["item"], "hidden", array())) {
                    ...
                    if ($this->getAttribute($this->getAttribute($this->getAttribute($context["item"], "form", array()), "fields", array()), "enabled", array())) {
                        ...
                        if (($context["overrideable"] ?? null)) {
                            // line 49
                            echo "                                                ";
                            $this->loadTemplate("forms/override.html.twig", "@gantry-admin/pages/configurations/content/content.html.twig", 49)->display(array_merge($context, array("scope" => ($context["prefix"] ?? null), "name" => "enabled", "default_value" => $this->getAttribute(($context["defaults"] ?? null), (($context["prefix"] ?? null) . "enabled")), "value" => $this->getAttribute($this->getAttribute(($context["gantry"] ?? null), "config", array()), "get", array(0 => (($context["prefix"] ?? null) . "enabled")), "method"), "field" => array("label" => (("Enabled of the " . $this->getAttribute(($context["particle"] ?? null), "name", array())) . " Particle")))));
                            // line 50
                            echo "                                            ";
                        }
                        // line 51
...
";
    ...
    {
        return new Twig_Source("", "@gantry-admin/pages/configurations/content/content.html.twig", "/Users/XMZ/EnterpriseWorks/gantry_wp/wp-content/plugins/gantry5/admin/templates/pages/configurations/content/content.html.twig");
    }
}
